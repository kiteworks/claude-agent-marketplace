...
- changed: agents/dpdpa-compliance-check.md
...
Detects Aadhaar numbers and email addresses, matches terms in folder names, reads spreadsheets and Word document titles reliably, and deletes its temporary local copies when a read-only run ends. <!-- whats-new: consolidated -->
