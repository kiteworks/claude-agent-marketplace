...
**[View on the Kiteworks Agent Marketplace →](https://agents.kiteworks.com/catalog/eu-ai-act-compliance-check)** — live examples, screenshots, and full detail.
...
**Claude Desktop:** download `eu-ai-act-compliance-check.plugin` and upload it via **Customize → Personal plugins → Upload plugin**.
