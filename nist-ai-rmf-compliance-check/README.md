...
**[View on the Kiteworks Agent Marketplace →](https://agents.kiteworks.com/catalog/nist-ai-rmf-compliance-check)** — live examples, screenshots, and full detail.
...
**Claude Desktop:** download `nist-ai-rmf-compliance-check.plugin` and upload it via **Customize → Personal plugins → Upload plugin**.
