...
- changed: agents/gdpr-compliance-check.md
...
Promoted to general availability at 1.0.0. No change to what the agent checks. The agent now states the marketplace terms acceptance line at the start of a session, and the bundle carries the current terms (version 2.0, effective 2026-08-15) instead of the superseded 1.0 install disclaimer. A stray build artifact published with an earlier bundle (`skills/kw-pdf-report/scripts/__pycache__/branded_pdf.cpython-314.pyc`) is no longer included. <!-- whats-new: consolidated -->
