...
- changed: agents/ccpa-compliance-check.md
...
Detects precise geolocation coordinates and email addresses, matches terms in folder names, reads spreadsheets and Word document titles reliably, and deletes its temporary local copies when a read-only run ends. <!-- whats-new: consolidated -->
