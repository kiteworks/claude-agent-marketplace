...
**[View on the Kiteworks Agent Marketplace →](https://agents.kiteworks.com/catalog/ccpa-compliance-check)** — live examples, screenshots, and full detail.
...
**Claude Desktop:** download `ccpa-compliance-check.plugin` and upload it via **Customize → Personal plugins → Upload plugin**.
