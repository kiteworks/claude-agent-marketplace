...
**[View on the Kiteworks Agent Marketplace →](https://agents.kiteworks.com/catalog/fedramp-compliance-check)** — live examples, screenshots, and full detail.
...
**Claude Desktop:** download `fedramp-compliance-check.plugin` and upload it via **Customize → Personal plugins → Upload plugin**.
