...
`v0.3.2` · updated 2026-09-24

Reports which Kiteworks folders have an expiry/retention policy configured and which don't.

**[View on the Kiteworks Agent Marketplace →](https://agents.kiteworks.com/catalog/folder-expiry-audit)** — live examples, screenshots, and full detail.
