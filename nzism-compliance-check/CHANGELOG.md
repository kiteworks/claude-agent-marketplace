...
- changed: skills/nzism-compliance-check/SKILL.md
...
Finds protective markings in Word document titles, matches terms in folder names, reads spreadsheets reliably, and deletes its temporary local copies when a read-only run ends. <!-- whats-new: consolidated -->
