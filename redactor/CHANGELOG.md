...
Reads PowerPoint speaker notes and grouped shapes, counts IBANs that run straight into the next field, and checks a file's scan status before reading it. <!-- whats-new: consolidated -->
